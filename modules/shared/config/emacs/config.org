...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Brian Bug"
    user-mail-address "thebrianbug@gmail.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/brianmcilwain/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/brianmcilwain/bin" "/profile/bin" "/Users/brianmcilwain/.npm-packages/bin" "/Users/brianmcilwain/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
